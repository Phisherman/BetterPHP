...
if (defined("__BUTTERPHP_BOOSTRAP__") || defined("__BUTTERPHP_ALL__")) {
    require_once __DIR__ . '/bootstrap/IUnit.php';
    require_once __DIR__ . '/bootstrap/IPreUnit.php';
